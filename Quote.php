...
class Mage_Sales_Model_Quote extends Mage_Core_Model_Abstract
{
   ...
   /**
     ...
     * @return Mage_Sales_Model_Quote_Item|string
     */
    public function addPayInStorePickupProductAdvanced(Mage_Catalog_Model_Product $product, $request = null, $processMode = null)
    {
        if ($request === null) {
            $request = 1;
        }
        ...
        $cartCandidates = $product->getTypeInstance(true)
            ->prepareForCartAdvanced($request, $product, $processMode);
		//jj will prepareForCartAdvanced interfere with my logic?
        /**
         * Error message
         */
        if (is_string($cartCandidates)) {
	...
	/*jj*/
    /**
     * Add product to quote to be paid and picked up in store
     *
     * return error message if product type instance can't prepare product
     *
     * @param mixed $product
     ...
     * @return Mage_Sales_Model_Quote_Item|string
     */
    public function addPayInStorePickupProduct(Mage_Catalog_Model_Product $product, $request = null)
    {
        return $this->addProductAdvanced(
            $product,
            $request,
	...
	/*jj*/
    /**
     * Add product to quote to be paid for online and picked up in store
     *
     * return error message if product type instance can't prepare product
     *
     * @param mixed $product
     ...
     * @return Mage_Sales_Model_Quote_Item|string
     */
    public function addPayOnlinePickupProduct(Mage_Catalog_Model_Product $product, $request = null)
    {
        return $this->addProductAdvanced(
            $product,
            $request,
	...
	/*jj*/
    /**
     * Add product to quote to be paid for online and shipped to shipping address
     *
     * return error message if product type instance can't prepare product
     *
     * @param mixed $product
     ...
     * @return Mage_Sales_Model_Quote_Item|string
     */
    public function addPayOnlineShipProduct(Mage_Catalog_Model_Product $product, $request = null)
    {
        return $this->addProductAdvanced(
            $product,
            $request,
